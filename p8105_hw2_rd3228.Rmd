...
pols <- read_csv("D:/P8105/hw2/fivethirtyeight_datasets/pols-month.csv")
...
```{r clean_snp}
# Read snp.csv data
snp <- read_csv("D:/P8105/hw2/fivethirtyeight_datasets/snp.csv")
...
unemployment <- read_csv("D:/P8105/hw2/fivethirtyeight_datasets/unemployment.csv")
...
mr_trash <- read_excel("D:/P8105/hw2/202409 Trash Wheel Collection Data.xlsx", 
...
professor_trash <- read_excel("D:/P8105/hw2/202409 Trash Wheel Collection Data.xlsx", 
...
gwynnda_trash <- read_excel("D:/P8105/hw2/202409 Trash Wheel Collection Data.xlsx", 
...
```{r clean_zip_codes}
# Read ZIP code data
zip_codes <- read_csv("D:/P8105/hw2/zillow_data/Zip Codes.csv") |>
  # Clean column names
  janitor::clean_names() |>
...
rental_data <- read_csv("D:/P8105/hw2/zillow_data/Zip_zori_uc_sfrcondomfr_sm_month_NYC.csv") |>
  # Clean column names
  janitor::clean_names() |>
...
all_zip_codes <- zip_codes$'ZIP Code'

zip_codes_with_data <- rental_data$'RegionName'
